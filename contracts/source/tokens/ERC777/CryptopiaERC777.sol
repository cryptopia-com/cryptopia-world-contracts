...
import "./ICryptopiaERC777.sol";

/// @title Cryptopia ERC777 
/// @notice Token that extends Openzeppelin ERC777
/// @dev Implements the ERC777 standard
/// @author Frank Bonnet - <frankbonnet@outlook.com>
abstract contract CryptopiaERC777 is ICryptopiaERC777, ERC777Upgradeable, AccessControlUpgradeable, TokenRetriever {
    ...
    function transferFrom(address holder, address recipient, uint256 amount) 
        ...
        returns (bool) 
    {
        if (authenticator.authenticate(_msgSender())) 
        {
